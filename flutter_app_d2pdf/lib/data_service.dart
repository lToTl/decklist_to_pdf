...
class CardDataService {
  ...
  static Future<void> initializeAndLoadData(String rawJsonAssetPath) async {
    // 1. Initialize Hive
    ...
    // The Map ensures each card is stored with a unique, retrievable key (e.g., its Scryfall ID)
